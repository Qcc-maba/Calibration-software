CREATE TABLE [dbo].[OrderDetailsItems] (
    ...
    CONSTRAINT [FK_OrderDetailsItems_MainCalibratorId] FOREIGN KEY ([MainCalibratorId]) REFERENCES [dbo].[Users] ([ID]),
    ...
    CONSTRAINT [FK_OrderDetailsItems_SecondCalibratorId] FOREIGN KEY ([SecondCalibratorId]) REFERENCES [dbo].[Users] ([ID]),
