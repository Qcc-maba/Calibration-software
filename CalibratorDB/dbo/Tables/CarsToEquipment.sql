CREATE TABLE [dbo].[CarsToEquipment] (
    ...
    CONSTRAINT [PK_CarsToEquipment] PRIMARY KEY CLUSTERED ([MeasurementDeviceId] ASC, [CarId] ASC, [CreatedDate] ASC),
    ...
    CONSTRAINT [FK_Equipment_EquipmentId] FOREIGN KEY ([MeasurementDeviceId]) REFERENCES [dbo].[MeasurementDevices] ([ID])
);
