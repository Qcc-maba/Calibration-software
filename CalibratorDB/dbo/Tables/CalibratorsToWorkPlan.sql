CREATE TABLE [dbo].[CalibratorsToWorkPlan] (
    ...
    [CalibratorsToWorkPlanId]     INT            IDENTITY (1, 1) NOT NULL,
    ...
    [CarId]                       INT            NULL,
    CONSTRAINT [PK_CalibratorsToWorkPlan] PRIMARY KEY CLUSTERED ([OrderWorkPlanId] ASC, [CalibratorId] ASC, [CalibratorsToWorkPlanId] ASC),
