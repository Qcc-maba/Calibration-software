...
USING (
	...
	FROM (
		...
		('CalibratedUnitsWorkStatus','','WaitingForCalibration',N'מחכה לכיול'),
		('CalibratedUnitsWorkStatus','','InCalibration',N'בכיול'),
		('CalibratedUnitsWorkStatus','','CalibrationFailed',N'כיול נכשל'),
		('CalibratedUnitsWorkStatus','','Packaged',N'אריזה'),
		('CalibratedUnitsWorkStatus','','CalibrationSuccess',N'כיול הצליח'),
