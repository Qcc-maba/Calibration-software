...
$InstalledExe = Join-Path $PSScriptRoot "consolehost\Maba.VCT.CommServer.Hosts.ConsoleHost.exe"
$DevExe       = Join-Path $PSScriptRoot "Systems\VCT\ComServer\ComServer.Hosts.ConsoleHost\bin\Release\Maba.VCT.CommServer.Hosts.ConsoleHost.exe"
