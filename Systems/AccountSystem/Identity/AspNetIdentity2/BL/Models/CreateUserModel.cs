...
namespace Maba.AccountSystem.AspNetIdentity.Identity2.BL.Models
{
    public class CreateUserModel
    {
        ...
        public CreateUserModel(ApplicationUserModel user)
        {
            //internals
        ...
        internal DAL.BaseUser CreateDAL()
        {
            var user = new DAL.BaseUser()
            {
                ...
                LongTimePattern = this.LongTimePattern,
                PhoneNumber = this.PhoneNumber,
                PhoneConfirmed = this.PhoneConfirmed,
                UIFormatID = this.UIFormatID,
                TimeZoneID = this.TimeZoneID,
                TemperatureUnitID = this.TemperatureUnitID,
                ShortDatePattern = this.ShortDatePattern,
                ShortTimePattern = this.ShortTimePattern,
