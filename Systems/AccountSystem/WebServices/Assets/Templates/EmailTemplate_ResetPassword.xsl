  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <title>Your  Account Information of Maba</title>
        <style type="text/css">
          /* Template styling */
          body {
                  ...
                  <td width="546" valign="top" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif !important; border-collapse: collapse;">
                    <div style="max-width: 600px; margin: 0 auto;">
                      ...
                      <div style="background: white; border-radius: 0.5rem; margin-bottom: 1rem;">
                        ...
                        <p style="font-size: 17px; line-height: 24px; margin: 10px 0px 16px;">
                          If you ignore this message<br /> your password will not be changed.
                        </p>
                        <p style="font-size: 17px; line-height: 24px; margin: 0px;">
                          <br />
                          <h5>
                            If you didn't request a reset password ,<a href="mailto:info@Mabac.com">notify us.</a>
                          </h5>
                        </p>
