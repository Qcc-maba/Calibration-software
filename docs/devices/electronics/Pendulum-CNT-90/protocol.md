...
> **סטטוס: זוהה ואומת בתקשורת מול החומרה — 2026-09-01.**
> לולאת המדידה **טרם אומתה עם אות אמיתי** — ראה "פתוח" בסוף.
...
- **הלולאה טרם רצה עם אות אמיתי.** לאמת ברגע שה-SDG6052X מוזן לכניסה A: שהשומר מזהה את האות, שהתדר
  נמדד ומשודר, ושהמעבר בין "יש אות" ל"אין אות" לא תוקע את ה-session.
