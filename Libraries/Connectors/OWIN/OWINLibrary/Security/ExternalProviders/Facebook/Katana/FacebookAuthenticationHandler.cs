...
namespace Maba.Connectors.OWINLibrary.Security.Externals.Facebook.Katana
{
    internal class FacebookAuthenticationHandler : AuthenticationHandler<FacebookAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                string fields = string.Join(",", Options.Fields);

                string graphAddress = String.Format("{0}?fields={1}&access_token={2}",
                ...
                var context = new Provider.FacebookAuthenticatedContext(Context, user, accessToken, expires);
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                var redirectContext = new Provider.FacebookApplyRedirectContext(
                    Context, Options,
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new Provider.FacebookReturnEndpointContext(Context, ticket);
